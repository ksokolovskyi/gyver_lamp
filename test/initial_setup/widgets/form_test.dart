...
void main() {
  group('InitialSetupForm', () {
    ...
    testWidgets('renders correctly', (tester) async {
      ...
      expect(find.text(tester.l10n.initialSetupPageTitle), findsOneWidget);
      expect(
        find.text(tester.l10n.initialSetupFormDescription),
        findsOneWidget,
      );
...
extension _InitialSetupForm on WidgetTester {
