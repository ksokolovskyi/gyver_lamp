...
void main() {
  group('VerticalRainbowFramesGenerator', () {
    final settingsVariant = GeneratorSettingsVariant.all();

    test('has correct blur value', () {
      expect(VerticalRainbowFramesGenerator(dimension: 16).blur, equals(10));
    });

    test('reset works correctly', () {
      const speed = 8;
      const scale = 33;
      final generator = VerticalRainbowFramesGenerator(dimension: 16);
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        final generator = VerticalRainbowFramesGenerator(
        ...
        await expectLater(
          ...
          matchesGoldenFile(
            'goldens/vertical_rainbow_frames_generator.${settings.id}.png',
          ),
        );
      },
