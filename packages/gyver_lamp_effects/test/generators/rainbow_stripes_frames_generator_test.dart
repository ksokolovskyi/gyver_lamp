...
void main() {
  group('RainbowStripesFramesGenerator', () {
    final settingsVariant = GeneratorSettingsVariant.all();

    test('has correct blur value', () {
      expect(RainbowStripesFramesGenerator(dimension: 16).blur, equals(20));
    });

    test('reset works correctly', () {
      const speed = 8;
      const scale = 33;
      final generator = RainbowStripesFramesGenerator(dimension: 16);
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        final generator = RainbowStripesFramesGenerator(
        ...
        await expectLater(
          ...
          matchesGoldenFile(
            'goldens/rainbow_stripes_frames_generator.${settings.id}.png',
          ),
        );
      },
