...
void main() {
  group('HorizontalRainbowFramesGenerator', () {
    final settingsVariant = GeneratorSettingsVariant.all();

    test('has correct blur value', () {
      expect(HorizontalRainbowFramesGenerator(dimension: 16).blur, equals(10));
    });

    test('reset works correctly', () {
      const speed = 8;
      const scale = 33;
      final generator = HorizontalRainbowFramesGenerator(dimension: 16);
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        final generator = HorizontalRainbowFramesGenerator(
        ...
        await expectLater(
          ...
          matchesGoldenFile(
            'goldens/horizontal_rainbow_frames_generator.${settings.id}.png',
          ),
        );
      },
